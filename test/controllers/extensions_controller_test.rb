...
class ExtensionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create extension" do
    assert_difference('Extension.count') do
      post extensions_url, params: { extension: { chat_id: @extension.chat_id, date: @extension.date, receiver_id: @extension.receiver_id, status: @extension.status, user_id: @extension.user_id } }
    end
  ...
  test "should update extension" do
    patch extension_url(@extension), params: { extension: { chat_id: @extension.chat_id, date: @extension.date, receiver_id: @extension.receiver_id, status: @extension.status, user_id: @extension.user_id } }

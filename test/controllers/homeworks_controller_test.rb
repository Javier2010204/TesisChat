...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post homeworks_url, params: { homework: { chat_id: @homework.chat_id, receiver_id: @homework.receiver_id, status: @homework.status, user_id: @homework.user_id } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { chat_id: @homework.chat_id, receiver_id: @homework.receiver_id, status: @homework.status, user_id: @homework.user_id } }
